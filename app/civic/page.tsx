...
export default function Civic() {
    return (
        <div className="bg-gray-200 w-full min-h-screen py-10">
            ...
            {/* Car Image */}
            <div className="flex justify-center">
                <img src="/04.jpg" alt="Honda Civic 2024" className="w-80 h-auto rounded-lg shadow-md" />
            </div>
            ...
            <p className="mx-auto max-w-3xl mt-4 text-gray-800 leading-relaxed px-6 text-lg">
                The current-generation <b>Honda Civic</b> is one of the automaker's best yet. Its packed with everything you did want from a small sedan or hatchback, including a spacious interior, impressive performance, and the latest technology and driver-assist features. For driving enthusiasts, there’s even the high-performance **315-horsepower Type R** version!
            </p>
